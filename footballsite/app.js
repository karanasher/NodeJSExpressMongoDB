...
//To create a connection to mongo db.
var mongo = require('mongodb');

var index = require('./routes/index');
var users = require('./routes/users');

//The route that will add a player in the db.
...
//When the user visits the /addplayer url, use addPlayer route to handle the db operations.
